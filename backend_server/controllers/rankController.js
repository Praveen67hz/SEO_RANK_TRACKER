...
export const addKeyword = async(req,res) =>{
    try {
        ...
        const existing = await KeywordTracking.findOne({userId: req.userId, keyword: keyword.
            toLowerCase().trim(),domain});
...
// Manually refresh a keyword ranking to get latest ranking
